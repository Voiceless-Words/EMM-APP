...
// 		}
//         // console.log(user);
//         submit_data(user, "http://192.168.250.1:3000/user/register");
//     });
...
// 				}
// 				else if (data.status == 1)
// 					window.location = "http://192.168.250.1:3000/dashboardb";
// 				else if (data.status == 2)
// 					window.location = "http://192.168.250.1:3000/dashboarda";
