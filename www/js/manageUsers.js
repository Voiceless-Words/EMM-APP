...
// 		}
//         // console.log(user);
//         submit_data(user, "http://emmapp.openode.io/user/register");
//     });
...
// 				}
// 				else if (data.status == 1)
// 					window.location = "http://emmapp.openode.io/dashboardb";
// 				else if (data.status == 2)
// 					window.location = "http://emmapp.openode.io/dashboarda";
