$(document).ready(function () {
    $("#registerForm").submit(function (e) {
        ...
        // console.log(user);
        submit_data(user, "http://192.168.43.152:8080/user/register");
    });
        ...
        $.ajax({
            ...
            success : function(data) {
				...
				else if (data.status == -1)
				{
					...
					window.location = "http://192.168.43.152:8080/dashboardb";
				else if (data.status == 2)
					window.location = "http://192.168.43.152:8080/dashboarda";
				if (path === "http://192.168.43.152:8080/user/register")
